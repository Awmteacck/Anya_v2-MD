...
module.exports = {
    ...
    ownernumber: process.env.Owner_Number || "918787651195",
    instagramId: process.env.Insta || "awmtea._polythene",

    /**
     * other details and parameters
     */
    author: process.env.Author || "@Awmtea",
    packname: process.env.PackName || "Queen Anya v2 MD",
    socialLink: process.env.Web || "https://github.com/Awmteacck",
    groupLink: process.env.GcLink || "https://whatsapp.com/channel/0029Vakp5lvI7BeHPAtVmx2a",
    warns: Number(process.env.Warn_Limits) || 3,
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 5, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "mongodb+srv://Bikash:Bikash@bikash.yl2nhcy.mongodb.net/?retryWrites=true&w=majority",
    sessionId: process.env.SESSION_ID || "a3BmMnh_Queen-Anya_zMzk=",
